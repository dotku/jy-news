...
summary: "美国国家安全局（NSA）正在使用Anthropic公司近期宣布但未向公众开放的高级人工智能模型“MythosPreview”，引发外界关注。数周前，NSA的上级机构美国国防部（五角大楼）才刚刚将Anthropic列为“供应链风险”，理由是该公司拒绝向五角大楼开放其模型的全部功能以供不受限制地使用。"
